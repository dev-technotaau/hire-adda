...
export const getRecommendedCandidates = async (
    ...
    try {
        ...
        const job = await prisma.jobPost.findFirst({
            ...
            select: {
                title: true, skillsRequired: true, location: true,
                experienceMin: true, experienceMax: true, industry: true,
                workMode: true, experienceLevel: true, educationRequired: true, type: true,
            },
        });
...
export const getRecommendedCandidatesForEmployer = async (
    ...
    try {
        ...
        const mostCommonLocation = locationCounts.size > 0
            ...
            : null;
        const mostCommonWorkMode = workModeCounts.size > 0

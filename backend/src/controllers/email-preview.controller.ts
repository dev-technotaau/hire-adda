...
> = {
  ...
  'job.newApplicationForEmployer': {
    ...
    sampleArgs: () => [
      ...
      'https://talentbridge.com/employer/applications/abc123',
    ],
  ...
  'job.offerReceived': {
    ...
    sampleArgs: () => [
      ...
      'Senior React Developer',
      'TechCorp Solutions',
      'https://talentbridge.com/candidate/offers/abc123',
    ],
      ...
      [
        {
          ...
          link: 'https://talentbridge.com/jobs/1',
        },
        {
          title: 'Full Stack Engineer',
          company: 'InnovateTech',
          location: 'Bangalore, India',
          link: 'https://talentbridge.com/jobs/2',
        },
        {
          title: 'Frontend Architect',
          company: 'DigitalFirst',
          location: 'Remote',
          link: 'https://talentbridge.com/jobs/3',
        },
      ],
    ],

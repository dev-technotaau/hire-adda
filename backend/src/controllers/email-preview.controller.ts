...
const TEMPLATE_REGISTRY: Record<string, {
    ...
    'auth.passwordReset': {
        ...
        sampleArgs: () => ['https://talentbridge.com/auth/reset-password?token=abc123def456'],
        description: 'Password reset link email',
    },
    'auth.loginAlert': {
        module: '../templates/email/auth',
        export: 'loginAlert',
        sampleArgs: () => ['February 16, 2026 at 10:30 AM IST', '203.0.113.42', 'Chrome 120 on Windows 11'],
    ...
    'job.newApplicationForEmployer': {
        ...
        sampleArgs: () => ['Mike Johnson', 'Jane Smith', 'Senior React Developer', 'https://talentbridge.com/employer/applications/abc123'],
        description: 'New application notification (to employer)',
    },
    'job.interviewScheduled': {
        module: '../templates/email/job',
        export: 'interviewScheduled',
        sampleArgs: () => ['Jane Smith', 'Senior React Developer', 'March 5, 2026 at 2:00 PM IST', 'https://meet.google.com/abc-defg-hij'],
        description: 'Interview scheduling notification',
    },
    'job.offerReceived': {
        module: '../templates/email/job',
        export: 'jobOfferReceived',
        sampleArgs: () => ['Jane Smith', 'Senior React Developer', 'TechCorp Solutions', 'https://talentbridge.com/candidate/offers/abc123'],
    ...
    'job.alert': {
        module: '../templates/email/job',
        export: 'jobAlert',
        sampleArgs: () => ['Jane Smith', [
            { title: 'Senior React Developer', company: 'TechCorp Solutions', location: 'Mumbai, India', link: 'https://talentbridge.com/jobs/1' },
            { title: 'Full Stack Engineer', company: 'InnovateTech', location: 'Bangalore, India', link: 'https://talentbridge.com/jobs/2' },
            { title: 'Frontend Architect', company: 'DigitalFirst', location: 'Remote', link: 'https://talentbridge.com/jobs/3' },
        ]],
    ...
    'onboarding.documentRejected': {
        module: '../templates/email/onboarding',
        export: 'documentVerificationStatus',
        sampleArgs: () => ['Government ID (Aadhaar)', 'rejected', 'The document image is blurry and the text is not legible.'],

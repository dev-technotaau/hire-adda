...
export const exportUsersExcel = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        const filters = {
...
export const exportJobsExcel = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        const filters = {
...
export const exportAnalyticsPdf = async (_req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {

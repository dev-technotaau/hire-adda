import { z } from 'zod';
import {
    Gender, WorkStatus, NoticePeriod, MaritalStatus, DisabilityType,
    WorkMode, ShiftType, JobType, LanguageProficiency,
} from '@prisma/client';
...
export const updateCandidateProfileSchema = z.object({
    body: z.object({
        ...
        careerBreakType: z.enum(['HEALTH', 'FAMILY', 'HIGHER_EDUCATION', 'TRAVEL', 'LAYOFF', 'PERSONAL', 'CAREGIVING', 'CAREER_TRANSITION', 'OTHER']).optional(),

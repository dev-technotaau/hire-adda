...
router.get('/suggest/locations', validate({ query: suggestQuery }), searchController.suggestLocations);
router.get('/suggest/companies', validate({ query: suggestQuery }), searchController.suggestCompanies);

...
import { createJobSchema, updateJobSchema, updateApplicationStatusSchema } from '../schemas/job.schema';
...
// Candidate actions
router.post('/:id/apply', protect, restrictTo(Role.CANDIDATE), jobController.applyToJob);

...
router.post('/users/:id/mfa/setup', audit('ADMIN_MFA_SETUP', 'User'), superAdminController.setupAdminMfa);
router.post('/users/:id/mfa/enable', audit('ADMIN_MFA_ENABLE', 'User'), superAdminController.enableAdminMfa);
router.post('/users/:id/mfa/disable', audit('ADMIN_MFA_DISABLE', 'User'), superAdminController.disableAdminMfa);
router.get('/users/:id/mfa/status', superAdminController.getAdminMfaStatus);
router.post('/users/:id/mfa/backup-codes', audit('ADMIN_MFA_BACKUP_REGEN', 'User'), superAdminController.regenerateAdminBackupCodes);

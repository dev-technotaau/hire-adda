...
router.post('/register/verify', protect, validate(registerVerifySchema), webauthnController.verifyRegistration);

// ===============================
// Authentication (Public)
// ===============================
router.post('/login/options', validate(loginOptionsSchema), webauthnController.getAuthenticationOptions);
...
router.delete('/credentials/:id', protect, validate(deleteCredentialSchema), webauthnController.deleteCredential);

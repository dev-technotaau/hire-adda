...
export const updateProfileSchema = z.object({
    ...
    noticePeriod: z.enum(['IMMEDIATE', 'FIFTEEN_DAYS', 'THIRTY_DAYS', 'SIXTY_DAYS', 'NINETY_DAYS', 'MORE_THAN_NINETY_DAYS']).optional(),
    workStatus: z.enum(['EMPLOYED', 'UNEMPLOYED', 'STUDENT', 'FREELANCER', 'ACTIVELY_LOOKING']).optional(),
    preferredJobType: z.array(z.enum(['FULL_TIME', 'PART_TIME', 'CONTRACT', 'INTERNSHIP', 'FREELANCE'])).optional(),

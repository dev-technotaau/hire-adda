...
const MIZORAM = ['Aizawl, Mizoram', 'Lunglei, Mizoram', 'Champhai, Mizoram'] as const;
...
const TRIPURA = ['Agartala, Tripura', 'Dharmanagar, Tripura', 'Udaipur, Tripura'] as const;
...
const CHANDIGARH = ['Chandigarh', 'Chandigarh IT Park', 'Chandigarh Sector 17'] as const;
...
const LADAKH = ['Leh, Ladakh', 'Kargil, Ladakh'] as const;
...
const ANDAMAN_NICOBAR = ['Port Blair, Andaman & Nicobar Islands'] as const;
...
const LAKSHADWEEP = ['Kavaratti, Lakshadweep'] as const;

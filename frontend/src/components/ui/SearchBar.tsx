...
import { useAutocomplete, useSearchHistory, usePopularSearches, useAddToSearchHistory, useClearSearchHistory } from '@/hooks/use-search';
        ...
        (e: KeyboardEvent<HTMLInputElement>) => {
            ...
            switch (e.key) {
                case 'ArrowDown': {
                    e.preventDefault();
                    const nextIndex =
                        activeIndex < navigableItems.length - 1
                            ? activeIndex + 1
                            : 0;
    ...
    return (
        ...
        >
            ...
            <div className="relative">
                ...
                <div className="absolute right-0 top-1/2 -translate-y-1/2 flex items-center gap-1 pr-2.5">
                    ...
                    {query && (
                        <button
                            type="button"
                            onClick={handleClear}
                            className="rounded-full p-0.5 text-[var(--text-muted)] hover:bg-[var(--bg-tertiary)] hover:text-[var(--text-secondary)] transition-colors"
                ...
                >
                        ...
                        <div className="py-1">
                            ...
                            <div className="border-t border-[var(--border)] px-3 py-2">
                                <button
                                    ...
                                    className="flex w-full items-center gap-2 rounded-lg px-2 py-1.5 text-sm text-primary hover:bg-[var(--primary-light)] transition-colors"
                                >
                                ...
                                <div>
                                    <div className="flex items-center justify-between px-3 py-1.5">
                                        ...
                                        <button
                                            ...
                                            className="flex items-center gap-1 text-[11px] text-[var(--text-muted)] hover:text-error transition-colors"
                                        >
                    ...
                    <div className="flex items-center gap-3 border-t border-[var(--border)] px-3 py-1.5 text-[11px] text-[var(--text-muted)]">
                        <span className="flex items-center gap-1">
                            <kbd className="rounded border border-[var(--border)] bg-[var(--bg-secondary)] px-1 py-0.5 font-mono text-[10px]">↑↓</kbd>
                            navigate
                        </span>
                        <span className="flex items-center gap-1">
                            <kbd className="rounded border border-[var(--border)] bg-[var(--bg-secondary)] px-1 py-0.5 font-mono text-[10px]">↵</kbd>
                        ...
                        <span className="flex items-center gap-1">
                            <kbd className="rounded border border-[var(--border)] bg-[var(--bg-secondary)] px-1 py-0.5 font-mono text-[10px]">esc</kbd>
                            close
                        </span>
                    </div>
                </div>

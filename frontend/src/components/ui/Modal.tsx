            ...
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <motion.div
                        ...
                        className={cn(
                            'relative w-full rounded-xl bg-white shadow-[var(--shadow-xl)] flex flex-col max-h-[calc(100vh-2rem)] outline-none',
                            sizeStyles[size],
                            className
                        )}
                    >
                        ...
                        {!title && (
                            <button
                                ...
                                onClick={onClose}
                                aria-label="Close dialog"
                                className="absolute right-4 top-4 rounded-lg p-1.5 text-[var(--text-muted)] transition-colors hover:bg-[var(--bg-secondary)] hover:text-[var(--text)] z-10"
                            >
                                <X className="h-5 w-5" />
                            </button>
                        )}

...
const AutoSuggest = forwardRef<AutoSuggestRef, AutoSuggestProps>(
    (
        ...
        const filteredSuggestions = suggestions.filter(
            (s) => !selectedValues.includes(s.value)
        );
            ...
            <div className={cn('relative w-full', className)} ref={containerRef}>
                ...
                >
                        ...
                        selectedValues.map((val) => {
                            ...
                            return (
                                <Tag
                                    ...
                                    size="sm"
                                    onRemove={
                                        disabled ? undefined : () => handleRemove(val)
                                    }
                                />
                            );
                        })}
                    ...
                    <input
                        ...
                        aria-activedescendant={
                            activeIndex >= 0
                                ? `autosuggest-option-${activeIndex}`
                                : undefined
                        }
                        className={cn(
                            'flex-1 min-w-[80px] border-none bg-transparent p-0 text-[var(--text)] placeholder:text-[var(--text-muted)]',
                ...
                {showDropdown && (
                    <div
                        ...
                        className={cn(
                            'absolute left-0 right-0 top-full z-50 mt-1 max-h-60 overflow-y-auto overscroll-contain',
                    ...
                    >
                        ...
                        {showCreate && (
                            <button
                                ...
                                className={cn(
                                    'flex w-full items-center gap-2 px-3 py-2 text-left text-sm transition-colors border-t border-[var(--border)]',

...
function Pagination({ currentPage, totalPages, onPageChange, totalItems, pageSize, className }: PaginationProps) {
        ...
        <div className={cn('flex flex-col items-center gap-3 sm:flex-row sm:justify-between', className)}>
            {totalItems !== undefined && pageSize && (
                <p className="text-sm text-[var(--text-muted)]">
                    Showing <span className="font-medium text-[var(--text)]">{showingFrom}</span>-<span className="font-medium text-[var(--text)]">{showingTo}</span> of{' '}

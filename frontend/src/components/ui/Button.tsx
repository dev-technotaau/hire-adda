    ...
    'inline-flex items-center justify-center font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
    {
        variants: {
            variant: {
                ...
                secondary: 'bg-[var(--bg-tertiary)] text-[var(--text)] hover:bg-[var(--border)] active:bg-[var(--border-hover)]',
                outline: 'border border-[var(--border)] bg-transparent text-[var(--text)] hover:bg-[var(--bg-secondary)] active:bg-[var(--bg-tertiary)]',
                ghost: 'bg-transparent text-[var(--text)] hover:bg-[var(--bg-secondary)] active:bg-[var(--bg-tertiary)]',

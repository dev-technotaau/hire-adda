                ...
                <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
                    ...
                    {this.state.error && (
                        <div className="mt-4 max-w-md w-full">
                            ...
                            <button
                                ...
                                className="mt-2 inline-flex items-center gap-1 text-xs text-[var(--text-muted)] hover:text-[var(--text-secondary)] transition-colors"
                            >
                    ...
                    <div className="mt-5 flex items-center gap-3">
                        <button
                            ...
                            className="inline-flex items-center gap-2 rounded-lg bg-primary px-4 py-2.5 text-sm font-medium text-white shadow-sm transition-colors hover:bg-primary-hover active:bg-primary-dark"
                        >

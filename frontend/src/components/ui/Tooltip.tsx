        ...
        >
            ...
            {isVisible && content && (
                <div
                    role="tooltip"
                    className={cn(
                        'absolute z-50 whitespace-nowrap rounded-md bg-[var(--text)] px-2.5 py-1.5 text-xs font-medium text-white shadow-[var(--shadow-md)] pointer-events-none animate-fade-in',

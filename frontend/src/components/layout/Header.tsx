...
export default function Header() {
    ...
    return (
        ...
        >
                    ...
                    {isAuthenticated && user ? (
                        <>
                            ...
                            >
                                ...
                                {unreadCount > 0 && (
                                    <span className="absolute -right-0.5 -top-0.5 flex h-5 min-w-5 items-center justify-center rounded-full bg-error px-1 text-xs font-medium text-white">
                            ...
                            <div className="relative">
                                ...
                                >
                                    ...
                                    <ChevronDown className={cn('hidden h-4 w-4 text-[var(--text-muted)] transition-transform lg:block', userMenuOpen && 'rotate-180')} />
                                </button>

                                {userMenuOpen && (
                                    <>
                                        <div className="fixed inset-0 z-40" onClick={() => setUserMenuOpen(false)} />
                                        <div className="absolute right-0 z-50 mt-2 w-56 overflow-hidden rounded-xl border border-[var(--border)] bg-white shadow-lg animate-scale-in">
            ...
            {/* Mobile Menu */}
            {mobileMenuOpen && (
                <div id="mobile-nav" className="border-t border-[var(--border)] bg-white md:hidden animate-slide-down" role="navigation" aria-label="Mobile navigation">

...
import {
    ...
    Settings, Building2, Users, PlusCircle, BarChart3,
    Shield, ShieldCheck, ClipboardList, Search, ChevronLeft, ChevronRight,
    FileBarChart, HelpCircle, MessageSquare, ToggleLeft, Sparkles, Bell,
} from 'lucide-react';
...
export function getNavItems(role: string | undefined): NavItem[] {
    switch (role) {
        ...
        case 'SUPER_ADMIN': return [...adminNav, ...superAdminNav];
        default: return [];
    }
}

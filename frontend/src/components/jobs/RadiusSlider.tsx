            ...
            {!hasGeo ? (
                ...
                <>
                    <div className="flex items-center gap-2">
                        <label htmlFor="radius-slider" className="text-xs text-[var(--text-muted)] whitespace-nowrap">
                            Within
                        </label>
                        <input
                            id="radius-slider"
                        ...
                        />
                        <span className="text-xs font-medium text-[var(--text)] tabular-nums min-w-[3.5rem]">
                            {radiusKm || '25'} km
                        </span>
                    </div>
                    <button
                        type="button"
                        onClick={onClear}
                        className="flex items-center gap-1 rounded-full px-2 py-0.5 text-[10px] text-[var(--text-muted)] hover:bg-[var(--bg-secondary)] transition-colors"

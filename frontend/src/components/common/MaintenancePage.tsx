...
export default function MaintenancePage() {
    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[var(--bg)]">
            ...
            <motion.div
                className="pointer-events-none absolute -top-32 -left-32 h-96 w-96 rounded-full bg-gradient-to-br from-primary/20 to-blue-500/10 blur-3xl"
                animate={{
                    x: [0, 60, -30, 0],
                    y: [0, -40, 50, 0],
                    scale: [1, 1.15, 0.95, 1],
                ...
                <div className="rounded-2xl border border-[var(--border)] bg-[var(--bg-secondary)] p-8 shadow-xl sm:p-12">
                    ...
                    {countdown && (
                        <motion.div
                            ...
                            className="mb-8"
                        >
                            <div className="mb-2 flex items-center justify-center gap-1.5 text-xs font-medium uppercase tracking-wider text-[var(--text-secondary)]">
                            ...
                            <div className="flex items-center justify-center gap-3">
                                {[
                                    ...
                                    <div key={label} className="text-center">
                                        <div className="flex h-14 w-14 items-center justify-center rounded-lg border border-[var(--border)] bg-[var(--bg)] text-xl font-bold tabular-nums text-[var(--text)]">
                                            {String(value).padStart(2, '0')}
                                        </div>
                                        <span className="mt-1 block text-[10px] font-medium uppercase tracking-wider text-[var(--text-secondary)]">
                                            {label}
                                        </span>
                                    </div>
                                ))}
                    ...
                    >
                        <button
                            ...
                            className="inline-flex items-center gap-2 rounded-lg bg-primary px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary/50"
                        >
                        ...
                        <a
                            ...
                            className="inline-flex items-center gap-2 rounded-lg border border-[var(--border)] px-5 py-2.5 text-sm font-medium text-[var(--text-secondary)] transition-colors hover:bg-[var(--bg)] focus:outline-none focus:ring-2 focus:ring-primary/50"
                        >
                    ...
                    >
                        Press <kbd className="rounded border border-[var(--border)] bg-[var(--bg)] px-1.5 py-0.5 font-mono text-[10px]">R</kbd> to refresh
                    </motion.p>
                </div>

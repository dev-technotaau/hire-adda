...
const config = {
  terms: {
    ...
    icon: FileText,
    intro:
      'Welcome to HireAdda. These Terms of Service ("Terms") govern your access to and use of the HireAdda website, applications, and services (collectively, the "Platform") operated by HireAdda Technologies Pvt. Ltd. ("HireAdda," "we," "us," or "our"), a company registered under the laws of India. Please read these terms carefully before using our platform.',
    sections: termsSections,
    footer:
      'These Terms of Service are effective as of February 1, 2026. HireAdda Technologies Pvt. Ltd. is registered under the laws of India with its registered office in Bangalore, Karnataka. By using our platform, you confirm that you accept these terms and agree to comply with them.',
  },
  privacy: {
    ...
    icon: Shield,
    intro:
      'At HireAdda Technologies Pvt. Ltd. ("HireAdda," "we," "us," or "our"), we are committed to protecting the privacy and security of your personal information. This Privacy Policy describes how we collect, use, share, and protect information when you use our website, mobile applications, and related services (collectively, the "Platform"). By using HireAdda, you agree to the collection and use of information in accordance with this policy.',
    sections: privacySections,
    footer:
      'This Privacy Policy is effective as of February 1, 2026. HireAdda Technologies Pvt. Ltd. is registered under the laws of India with its registered office in Bangalore, Karnataka.',
  },
} as const;

...
const config = {
    terms: {
        ...
        icon: FileText,
        intro: 'Welcome to TalentBridge. These Terms of Service ("Terms") govern your access to and use of the TalentBridge website, applications, and services (collectively, the "Platform") operated by TalentBridge Technologies Pvt. Ltd. ("TalentBridge," "we," "us," or "our"), a company registered under the laws of India. Please read these terms carefully before using our platform.',
        sections: termsSections,
        footer: 'These Terms of Service are effective as of February 1, 2026. TalentBridge Technologies Pvt. Ltd. is registered under the laws of India with its registered office in Bangalore, Karnataka. By using our platform, you confirm that you accept these terms and agree to comply with them.',
    },
    privacy: {
        title: 'Privacy Policy',
        subtitle: 'Last updated: February 2026',
        icon: Shield,
        intro: 'At TalentBridge Technologies Pvt. Ltd. ("TalentBridge," "we," "us," or "our"), we are committed to protecting the privacy and security of your personal information. This Privacy Policy describes how we collect, use, share, and protect information when you use our website, mobile applications, and related services (collectively, the "Platform"). By using TalentBridge, you agree to the collection and use of information in accordance with this policy.',
        sections: privacySections,
        footer: 'This Privacy Policy is effective as of February 1, 2026. TalentBridge Technologies Pvt. Ltd. is registered under the laws of India with its registered office in Bangalore, Karnataka.',
    },
} as const;
            ...
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center sm:p-4">
                    ...
                    >
                        ...
                        {/* Header */}
                        <div className="flex items-start justify-between border-b border-[var(--border)] px-6 pb-4 pt-4 sm:pt-5">

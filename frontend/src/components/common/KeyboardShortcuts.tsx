...
export default function KeyboardShortcuts() {
    ...
    return (
        <div className="fixed inset-0 z-[500] flex items-start justify-center pt-[20vh]">
            ...
            {/* Palette */}
            <div className="relative z-10 w-full max-w-lg rounded-2xl border border-[var(--border)] bg-white shadow-2xl animate-scale-in">
                ...
                <div className="border-t border-[var(--border)] px-4 py-2">
                    <p className="text-xs text-[var(--text-muted)]">
                        <kbd className="rounded bg-[var(--bg-tertiary)] px-1.5 py-0.5 text-xs font-mono">Ctrl</kbd>
                        {' + '}
                        <kbd className="rounded bg-[var(--bg-tertiary)] px-1.5 py-0.5 text-xs font-mono">K</kbd>
                        {' to toggle'}
                    </p>
                </div>
            </div>

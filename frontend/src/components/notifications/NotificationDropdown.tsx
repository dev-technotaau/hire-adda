...
import {
    Bell, CheckCheck, Info, CheckCircle,
...
export default function NotificationDropdown({ onClose }: NotificationDropdownProps) {
    ...
    return (
        <div className="absolute right-0 z-50 mt-2 w-80 rounded-xl border border-[var(--border)] bg-white shadow-lg sm:w-96 animate-scale-in">
                ...
                {isLoading ? (
                    ...
                    notifications.map((notification) => {
                        ...
                        const content = (
                            <div
                                className={cn(
                                    'flex gap-3 px-4 py-3 transition-colors hover:bg-[var(--bg-secondary)] cursor-pointer',
                            ...
                            >
                                ...
                                <div className="min-w-0 flex-1">
                                    <p className={cn('text-sm', !notification.isRead ? 'font-medium text-[var(--text)]' : 'text-[var(--text-secondary)]')}>
                                        {notification.title}
                                    </p>
            ...
            <div className="border-t border-[var(--border)] p-2">
                <Link
                    ...
                    onClick={onClose}
                    className="block rounded-lg py-2 text-center text-sm font-medium text-primary transition-colors hover:bg-primary-light"
                >

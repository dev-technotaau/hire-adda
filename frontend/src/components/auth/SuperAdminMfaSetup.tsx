                        ...
                        {step === 'idle' && (
                            <div className="space-y-4">
                                <div className="rounded-lg bg-[var(--bg-secondary)] p-4 text-sm text-[var(--text-muted)]">
                                    <p>
                                        You need to set up two-factor authentication using an
                                        authenticator app (e.g., Google Authenticator, Authy) before
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        <code className="flex-1 break-all rounded-lg bg-[var(--bg-secondary)] px-3 py-2 font-mono text-sm text-[var(--text)]">
                                            {mfaSetup.secret}
                                        </code>
                                        <Button
                                            variant="ghost"

                    ...
                    <div className="rounded-2xl border border-[var(--border)] bg-white p-6 shadow-sm sm:p-8">
                        <div className="mb-6 text-center">
                            ...
                            <p className="mt-3 text-sm text-[var(--text-secondary)]">
                                ...
                                Please contact a Super Admin to set up MFA for your account.
                            </p>
                        </div>

                        <div className="rounded-lg bg-[var(--bg-secondary)] p-4 text-sm text-[var(--text-muted)]">
                            <p>
                                For security purposes, admin MFA must be configured by a Super Admin.
                                Once MFA is enabled for your account, you will be able to access the
                                admin panel.
                            </p>
                        </div>

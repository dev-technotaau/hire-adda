...
/**
 * Shared register form used by /auth/register/candidate, /auth/register/employer
 * and /auth/register/vendor. Role is locked at the page level — the form
...
export default function RoleRegisterForm({ role }: RoleRegisterFormProps) {
  ...
  const handleInfoNext = async () => {
    ...
    if (activeTab === 'EMPLOYER' || activeTab === 'VENDOR') fields.push('companyName');
          ...
          <AnimatePresence mode="wait">
            {step === 'info' && (
              ...
              >
                ...
                {(activeTab === 'EMPLOYER' || activeTab === 'VENDOR') && (
                  <Input
                    label={activeTab === 'VENDOR' ? 'Agency / Business Name' : 'Company Name'}
                    placeholder={
                      activeTab === 'VENDOR' ? 'Your recruitment agency name' : 'Your company name'
                    }
          ...
          <>
            ...
            <p className="mt-2 text-center text-xs text-[var(--text-muted)]">
              {role === 'CANDIDATE' ? (
                ...
                >
                  Register as Employer or Vendor →
                </Link>
              ) : role === 'EMPLOYER' ? (
                <Link
                  href={ROUTES.AUTH.REGISTER}
                  className="hover:text-[var(--text)] hover:underline"
                >
                  Register as Candidate or Vendor →
                </Link>
              ) : (
                <Link
                  href={ROUTES.AUTH.REGISTER}

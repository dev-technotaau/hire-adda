...
import {
    User, MapPin, Phone, Mail, Camera, X, Loader2,
} from 'lucide-react';
...
import {
    ...
    PRONOUN_OPTIONS, RESERVATION_CATEGORY_LABELS,
} from '@/constants/enums';
import {
    NATIONALITY_SUGGESTIONS, LOCATION_SUGGESTIONS,
    INDIAN_STATES, COUNTRY_SUGGESTIONS,
                ...
                <div className="space-y-2">
                    <div className="flex items-center gap-2">
                        <label className="cursor-pointer">
                            <input type="file" accept=".jpg,.jpeg,.png,.webp" onChange={handleFileSelect} className="sr-only" />
...
export default function PersonalSection({ form, updateField, profile }: PersonalSectionProps) {
    return (
        <>
            ...
            <Card header={<h2 className="text-lg font-semibold text-[var(--text)]">Personal Information</h2>}>
                <div className="space-y-4">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <Select
                            ...
                            onChange={(v) => updateField('maritalStatus', v as UpdateCandidateRequest['maritalStatus'])}

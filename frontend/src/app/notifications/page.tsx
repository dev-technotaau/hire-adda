        ...
        <DashboardLayout requiredRole={['CANDIDATE', 'EMPLOYER', 'ADMIN', 'SUPER_ADMIN']}>
            <div className="space-y-6">
                ...
                <div className="overflow-x-auto">
                    <Tabs tabs={filterTabs} activeTab={filter} onChange={(v) => { setFilter(v); setPage(1); }} />
                </div>
                ...
                <div className="min-w-0 flex-1">
                    <div className="flex items-start justify-between gap-2">
                        <div>
                            <p className={cn(
                                'text-sm',
                                !notification.isRead ? 'font-semibold text-[var(--text)]' : 'font-medium text-[var(--text-secondary)]'
                            )}>
                                {notification.title}
                            </p>
                        ...
                        {!notification.isRead && (
                            <button
                                ...
                                className="shrink-0 rounded-lg p-1.5 text-[var(--text-muted)] transition-colors hover:bg-[var(--bg-secondary)] hover:text-primary"
                                title="Mark as read"
                            >

...
import {
    Briefcase, Search, Building2, Eye,
    Calendar, CheckCircle, XCircle, Flag,
    AlertCircle, Users, Trash2,
} from 'lucide-react';
            ...
            <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-start gap-3">
                            ...
                            <p className="text-sm text-[var(--text-secondary)]">
                                You are about to reject <span className="font-medium text-[var(--text)]">{rejectTarget?.title}</span>. The employer will be notified.
                            </p>
                        </div>
                        <Input
                            label="Reason"
                ...
                >
                    <div className="space-y-4">
                        <div className="flex items-start gap-3">
                            ...
                            <p className="text-sm text-[var(--text-secondary)]">
                                Flag <span className="font-medium text-[var(--text)]">{flagTarget?.title}</span> for review. Provide a reason below.
                            </p>
                        </div>
                        <Input
                            label="Reason"
                ...
                >
                    <div className="flex items-start gap-3">
                        ...
                        <p className="text-sm text-[var(--text-secondary)]">
                            Are you sure you want to permanently delete <span className="font-medium text-[var(--text)]">{deleteTarget?.title}</span>? This action cannot be undone.
                        </p>
                    </div>
                </Modal>
            </div>

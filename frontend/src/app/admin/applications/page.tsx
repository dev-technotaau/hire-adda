...
const PIE_COLORS = ['#6366f1', '#22c55e', '#f59e0b', '#3b82f6', '#ef4444', '#8b5cf6', '#ec4899', '#64748b'];
            ...
            <div className="space-y-6">
                ...
                {statsLoading ? (
                    ...
                    <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
                        ...
                        <Card>
                            <div className="p-4 text-center">
                                <p className="text-2xl font-bold text-[var(--success)]">{stats.byStatus['HIRED'] || 0}</p>
                                <p className="text-xs text-[var(--text-muted)]">Hired</p>
                            </div>
                        </Card>
                        <Card>
                            <div className="p-4 text-center">
                                <p className="text-2xl font-bold text-[var(--warning)]">{stats.byStatus['SHORTLISTED'] || 0}</p>
                                <p className="text-xs text-[var(--text-muted)]">Shortlisted</p>
                            </div>
                        </Card>
                        <Card>
                            <div className="p-4 text-center">
                                <p className="text-2xl font-bold text-primary">{stats.byStatus['APPLIED'] || 0}</p>
                ...
                {stats && (
                    <div className="grid gap-6 lg:grid-cols-2">
                        ...
                        <Card>
                            <div className="p-6">
                                <h3 className="text-sm font-semibold text-[var(--text)]">Applications (Last 30 Days)</h3>
                                <div className="mt-4 h-56">
                                    <ResponsiveContainer width="100%" height="100%">
                                        <AreaChart data={stats.dailyTrend}>
                                            ...
                                            <Tooltip />
                                            <Area type="monotone" dataKey="count" stroke="#6366f1" fill="#6366f1" fillOpacity={0.15} name="Applications" />
                                        </AreaChart>
                                    </ResponsiveContainer>
                                </div>
                            </div>
                ...
                <Card>
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="border-b border-[var(--border)] text-left text-xs font-medium uppercase text-[var(--text-muted)]">

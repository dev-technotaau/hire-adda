...
export const metadata: Metadata = {
    title: 'Refund Policy',
    description: 'Understand the TalentBridge refund and cancellation policy for premium plans and paid services.',
};
                ...
                <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                    <div className="rounded-xl border border-[var(--border)] bg-white p-6 sm:p-10">
                        <p className="leading-relaxed text-[var(--text-secondary)]">
                            This Refund Policy governs all paid services offered by TalentBridge
                            Technologies Pvt. Ltd. (&quot;TalentBridge,&quot; &quot;we,&quot;
                            &quot;us,&quot; or &quot;our&quot;). We aim to be fair and transparent
                            in all billing matters. Please read this policy carefully before making
                            any purchase on our platform.
                        </p>
                        ...
                        <div className="mt-10 border-t border-[var(--border)] pt-6">
                            <p className="text-sm text-[var(--text-muted)]">
                                This Refund Policy is effective as of February 1, 2026. TalentBridge
                                Technologies Pvt. Ltd. is registered under the laws of India with its
                                registered office in Bangalore, Karnataka. All refund decisions are at
                                the sole discretion of TalentBridge and are final.
                            </p>
                        </div>
                    </div>
                </div>

                ...
                <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <p className="mx-auto mt-6 max-w-2xl text-lg text-[var(--text-secondary)]">
                            Find answers to common questions about using TalentBridge.
                        ...
                        <div className="relative mx-auto mt-8 max-w-xl">
                            ...
                            <input
                                ...
                                className="h-12 w-full rounded-xl border border-[var(--border)] bg-white pl-12 pr-4 text-[var(--text)] placeholder:text-[var(--text-muted)] shadow-sm transition-colors duration-200 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
                            />
                        </div>
                    </div>
                </div>
            ...
            {user && (
                <section className="border-t border-[var(--border)] bg-white py-12">
                    <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
                        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-xl bg-primary-light">
                        ...
                        <p className="mt-2 text-[var(--text-secondary)]">
                            Create a support ticket to track your issue and get a dedicated response from our team.
                        </p>
                        <Link
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="mb-10 text-center">
                        ...
                        <p className="mx-auto mt-3 max-w-xl text-[var(--text-secondary)]">
                            Our support team is ready to assist you. Reach out through any of the
                            channels below.
                        </p>
                    </div>

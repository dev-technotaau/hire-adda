...
export const metadata: Metadata = {
    title: 'About Us',
    description: 'Learn about Talent Bridge — our mission to connect talent with opportunity across India. Meet our team and discover our values.',
...
export default function AboutPage() {
    return (
        <PublicLayout>
            {/* Hero Section */}
            <section className="relative overflow-hidden bg-gradient-to-br from-primary-50 via-white to-[var(--accent-light)]">
                    ...
                    <div className="grid items-center gap-12 lg:grid-cols-2">
                        <div>
                            ...
                            <p className="mt-6 text-lg leading-relaxed text-[var(--text-secondary)]">
                                At TalentBridge, we believe that the right job can change a life, and the right
                                hire can transform a business. Our mission is to connect talent with opportunity
                                across India, making the recruitment process smarter, faster, and more equitable
                                for everyone involved.
                            </p>
                            <p className="mt-4 text-lg leading-relaxed text-[var(--text-secondary)]">
                                Founded in 2024, we set out to solve the inefficiencies that plague traditional
                                hiring. From AI-powered job matching to verified employer profiles, every feature
                                we build is designed to create meaningful connections between candidates and
                                companies.
                            </p>
                            <p className="mt-4 text-lg leading-relaxed text-[var(--text-secondary)]">
                                Whether you are a fresh graduate looking for your first opportunity or a seasoned
                                professional seeking your next challenge, TalentBridge is here to help you take
                                the next step in your career journey.
                            </p>
                        </div>
                        <div className="rounded-2xl border border-[var(--border)] bg-[var(--bg-secondary)] p-8 sm:p-12">
                            <blockquote className="text-lg italic leading-relaxed text-[var(--text-secondary)]">
                                &ldquo;We envision an India where geography, background, and connections no
                                longer determine career outcomes. TalentBridge exists to level the playing
                                field and let merit shine.&rdquo;
                            </blockquote>
                            <div className="mt-6">
            ...
            <section className="border-y border-[var(--border)] bg-[var(--bg-secondary)] py-16">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="mb-10 text-center">
                        <h2 className="text-3xl font-bold text-[var(--text)] sm:text-4xl">Our Impact in Numbers</h2>
                        ...
                        {team.map((member) => (
                            ...
                            >
                                ...
                                <div className="mt-4 flex items-center justify-center gap-3">
                                    <span className="flex h-8 w-8 items-center justify-center rounded-full bg-[var(--bg-secondary)] text-[var(--text-muted)] transition-colors hover:bg-primary-light hover:text-primary">

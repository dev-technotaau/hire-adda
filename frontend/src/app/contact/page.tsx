...
export default function ContactPage() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            showToast.success(`Ticket ${result.data.ticketNumber} created!`, 'We will respond within 24 hours.');
                                ...
                                <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                                    ...
                                    <div className="grid gap-6 sm:grid-cols-2">
                                        <div className="w-full">
                                            ...
                                            >
                                                Subject<span className="ml-0.5 text-error">*</span>
                                            </label>
                                            <input
                                                id="subject"
                                                name="subject"
                                                ...
                                                onChange={handleChange}
                                                required
                                                className="h-10 w-full rounded-lg border border-[var(--border)] bg-white px-3 text-sm text-[var(--text)] placeholder:text-[var(--text-muted)] transition-colors duration-200 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
                                            />
                                        </div>
                                        <div className="w-full">
                                            <label
                                            ...
                                            <select
                                                ...
                                                value={form.category}
                                                onChange={handleChange}
                                                className="h-10 w-full rounded-lg border border-[var(--border)] bg-white px-3 text-sm text-[var(--text)] transition-colors duration-200 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
                                            >
                                    ...
                                    <div className="w-full">
                                        ...
                                        <textarea
                                            ...
                                            onChange={handleChange}
                                            required
                                            className="w-full rounded-lg border border-[var(--border)] bg-white px-3 py-2.5 text-sm text-[var(--text)] placeholder:text-[var(--text-muted)] transition-colors duration-200 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 disabled:cursor-not-allowed disabled:bg-[var(--bg-secondary)] disabled:opacity-60"
                                        />
                                    </div>
                                    ...
                                    >
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="mt-1 font-medium text-primary">{info.detail}</p>

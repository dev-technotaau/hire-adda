                    ...
                    {unlockedContact ? (
                      <div className="space-y-1.5">
                        {unlockedContact.email && (
                          ...
                          >
                            <Mail className="h-4 w-4 flex-shrink-0" /> {unlockedContact.email}
                          </a>
                        )}
                        {unlockedContact.phone && (
                          <a
                            ...
                            onClick={() => setContactOpen(false)}
                          >
                            <Phone className="h-4 w-4 flex-shrink-0" /> {unlockedContact.phone}
                          </a>
                        )}
                        {unlockedContact.phone && (
                          <a
                      ...
                      <div className="space-y-2 p-2">
                        ...
                        <UnlockContactButton candidateId={String(id)} />
                        {hasFeature('feature.cv_db_access') ? (
                          <button
                            type="button"
                            onClick={async () => {
                              try {
                                const res = await cvUnlockService.unlock(String(id));

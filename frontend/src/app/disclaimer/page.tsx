...
export const metadata: Metadata = {
    title: 'Disclaimer',
    description: 'Read the TalentBridge disclaimer regarding the use of our job portal platform and the information provided therein.',
};
                ...
                <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                    <div className="rounded-xl border border-[var(--border)] bg-white p-6 sm:p-10">
                        <p className="leading-relaxed text-[var(--text-secondary)]">
                            ...
                            &quot;us,&quot; or &quot;our&quot;) through our platform. By accessing and
                            using TalentBridge, you acknowledge that you have read, understood, and
                        ...
                        <div className="mt-10 border-t border-[var(--border)] pt-6">
                            <p className="text-sm text-[var(--text-muted)]">
                                This Disclaimer is effective as of February 1, 2026. TalentBridge

...
export const metadata: Metadata = {
  title: 'Disclaimer',
  description:
    'Read the HireAdda disclaimer regarding the use of our job portal platform and the information provided therein.',
};
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-xl border border-[var(--border)] bg-white p-6 sm:p-10">
            <p className="leading-relaxed text-[var(--text-secondary)]">
              This Disclaimer applies to all content and services provided by HireAdda Technologies
              Pvt. Ltd. (&quot;HireAdda,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;)
              through our platform. By accessing and using HireAdda, you acknowledge that you have
            ...
            <div className="mt-10 border-t border-[var(--border)] pt-6">
              <p className="text-sm text-[var(--text-muted)]">
                This Disclaimer is effective as of February 1, 2026. HireAdda Technologies Pvt. Ltd.
                is registered under the laws of India with its registered office in Bangalore,

        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-xl border border-[var(--border)] bg-white p-6 sm:p-10">
            <p className="leading-relaxed text-[var(--text-secondary)]">
              This Disclaimer applies to all content and services provided by Hire Adda Technologies
              Pvt. Ltd. (&quot;Hire Adda,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;)
            ...
            <div className="mt-10 border-t border-[var(--border)] pt-6">
              <p className="text-sm text-[var(--text-muted)]">
                This Disclaimer is effective as of February 1, 2026. Hire Adda Technologies Pvt.

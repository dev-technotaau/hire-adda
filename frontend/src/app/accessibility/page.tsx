...
export const metadata: Metadata = {
    ...
    description: 'TalentBridge is committed to making our platform accessible to all users, including people with disabilities.',
};
                ...
                <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                    <div className="rounded-xl border border-[var(--border)] bg-white p-6 sm:p-10">
                        <p className="leading-relaxed text-[var(--text-secondary)]">
                            TalentBridge Technologies Pvt. Ltd. (&quot;TalentBridge,&quot;
                            &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) is committed to
                            providing a platform that is accessible to the widest possible audience,
                            regardless of technology or ability. This accessibility statement outlines
                            our efforts to ensure an inclusive experience for all users.
                        </p>
                        ...
                        <div className="mt-10 border-t border-[var(--border)] pt-6">
                            <p className="text-sm text-[var(--text-muted)]">
                                This Accessibility Statement is effective as of February 1, 2026 and
                                was last reviewed on February 1, 2026. TalentBridge Technologies Pvt.
                                Ltd. is registered under the laws of India with its registered office
                                in Bangalore, Karnataka. We are committed to making our platform

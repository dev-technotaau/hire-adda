                    ...
                    {status === 'verifying' && (
                        ...
                        >
                            <div className="text-center py-8">
                                ...
                                <h2 className="text-lg font-semibold text-[var(--text)]">Verifying Your Email...</h2>
                                <p className="mt-2 text-sm text-[var(--text-muted)]">Please wait while we verify your email address.</p>
                            </div>
                        </motion.div>
                    )}
                        ...
                        >
                            <div className="text-center">
                                ...
                                <p className="mt-2 text-sm text-[var(--text-muted)]">
                                    ...
                                    {email && (
                                        <span className="block mt-1 font-medium text-[var(--text)]">{email}</span>
                                    )}
                                </p>
                            </div>

                            <form onSubmit={(e) => { e.preventDefault(); handleOtpSubmit(); }} className="mt-6 space-y-6">
                                <OtpInput
                                    value={otp}
                                    onChange={setOtp}

...
export default function VerifyEmploymentPage() {
    ...
    const mutation = useMutation({
        mutationFn: () => verificationService.submitEmploymentResponse(token, action, comments || undefined),
                ...
                <div className="p-8">
                    ...
                    <div className="mt-6 space-y-4">
                        ...
                        <Textarea
                            ...
                            placeholder={action === 'confirm' ? 'Any additional details...' : 'Please explain what is inaccurate...'}
                            value={comments}
                        ...
                        {mutation.isError && (
                            <p className="text-sm text-error">
                                {(mutation.error as unknown as ApiError)?.message || 'Something went wrong. Please try again.'}
                            </p>
                        )}
                    ...
                    <p className="mt-6 text-center text-xs text-[var(--text-muted)]">
                        This is a one-time verification request from Talent Bridge.
                        Your response will help us maintain accurate employment records.
                    </p>
                </div>
            </Card>
        </div>

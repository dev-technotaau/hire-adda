...
export const metadata: Metadata = {
  ...
  description:
    'Read the Talent Bridge privacy policy. Learn how we collect, use, and protect your personal information.',
};
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-xl border border-[var(--border)] bg-white p-6 sm:p-10">
            <p className="leading-relaxed text-[var(--text-secondary)]">
              ...
              related services (collectively, the &quot;Platform&quot;). By using TalentBridge, you
            ...
            <div className="mt-10 border-t border-[var(--border)] pt-6">
              <p className="text-sm text-[var(--text-muted)]">
                This Privacy Policy is effective as of February 1, 2026. TalentBridge Technologies

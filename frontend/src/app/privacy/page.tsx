...
export const metadata: Metadata = {
    ...
    description: 'Read the Talent Bridge privacy policy. Learn how we collect, use, and protect your personal information.',
};
                ...
                <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                    <div className="rounded-xl border border-[var(--border)] bg-white p-6 sm:p-10">
                        <p className="leading-relaxed text-[var(--text-secondary)]">
                            At TalentBridge Technologies Pvt. Ltd. (&quot;TalentBridge,&quot; &quot;we,&quot;
                            &quot;us,&quot; or &quot;our&quot;), we are committed to protecting the privacy
                            and security of your personal information. This Privacy Policy describes how we
                            collect, use, share, and protect information when you use our website, mobile
                            applications, and related services (collectively, the &quot;Platform&quot;). By
                            using TalentBridge, you agree to the collection and use of information in
                        ...
                        <div className="mt-10 border-t border-[var(--border)] pt-6">
                            <p className="text-sm text-[var(--text-muted)]">
                                This Privacy Policy is effective as of February 1, 2026. TalentBridge

...
import {
    ...
    CheckCircle, XCircle, ArrowRight, ArrowUpRight, ArrowDownRight,
    MapPin, Layers, Timer,
} from 'lucide-react';
...
export default function CandidateAnalyticsPage() {
    ...
    const summaryCards = analytics ? [
        { label: 'Total Applications', value: analytics.summary.totalApplications, icon: FileText, color: 'text-primary bg-primary-light', deltaKey: 'totalApplications' as const },
                            ...
                            <Card
                                header={
                                    <div className="flex items-center gap-2">
                                        ...
                                        <h2 className="text-lg font-semibold text-[var(--text)]">Employer Response Time</h2>
                                    </div>
                                }
                            >
                                <PieChart

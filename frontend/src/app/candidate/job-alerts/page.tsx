...
import {
    Bell, Plus, Pencil, Trash2, Eye, Clock, MapPin,
    Briefcase, Search, X,
} from 'lucide-react';
...
import type { JobAlert, CreateJobAlertRequest, UpdateJobAlertRequest, AlertFrequency } from '@/types/candidate';
                ...
                {isLoading ? (
                    <div className="space-y-4">
                        {Array.from({ length: 3 }).map((_, i) => (
                            <Card key={i}><Skeleton variant="rect" height={100} /></Card>
                        ))}
                    </div>
                ) : alerts.length === 0 ? (
                    <Card>
                                ...
                                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <Switch
                                            ...
                                            onChange={() => toggleMutation.mutate({ id: alert.id, isActive: !alert.isActive })}
                                        />
                                        <Button
                                            variant="ghost"
                                            size="sm"

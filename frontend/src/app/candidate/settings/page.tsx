...
import {
    Lock, Shield, Bell, Eye, Smartphone, Monitor,
    Trash2, KeyRound, LogOut, Globe, Users, EyeOff,
    FileText, QrCode, Copy, Check, Mail, Fingerprint, Plus, Scale, Phone, CheckCircle, MessageCircle,
} from 'lucide-react';
            ...
            >
                <div className="space-y-4">
                    <p className="text-sm text-[var(--text-secondary)]">
                        ...
                        All your data, including your profile, applications, and saved jobs will be permanently deleted.
                    </p>
                    <Input
...
function NotificationsTab() {
    ...
    useEffect(() => {
        const p = (profileData?.data as unknown as Record<string, unknown>)?.notificationPreferences as Record<string, boolean> | undefined;
        if (p) {
            setPreferences(prev => ({
                    ...
                    {visibilityOptions.map((option) => (
                        ...
                        >
                            <input
                                ...
                                className="h-4 w-4 text-primary border-[var(--border)] focus:ring-primary"
                            />

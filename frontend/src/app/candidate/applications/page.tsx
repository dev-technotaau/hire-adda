...
import {
    Briefcase, Building2, Clock, MapPin,
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-3">
                    {isLoading ? (
                        ...
                        <EmptyState
                            icon={Briefcase}
                            title={statusFilter === 'ALL' ? 'No applications yet' : `No ${APPLICATION_STATUS_LABELS[statusFilter] || statusFilter} applications`}
                ...
                <Modal
                    ...
                    footer={
                        <div className="flex justify-end gap-3">
                            ...
                            <Button variant="destructive" onClick={handleWithdraw} isLoading={withdrawMutation.isPending}>
                                Withdraw
                            </Button>
                        </div>
                    }
                >
                    <div className="flex items-start gap-3">
                        ...
                        <p className="text-sm text-[var(--text-secondary)]">
                            Are you sure you want to withdraw this application? This action cannot be undone and the employer will be notified.
                        </p>
                    </div>
                </Modal>
            </div>
        ...
        <Card className="hover:shadow-sm transition-shadow">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex items-center gap-3 shrink-0">
                    ...
                    {canWithdraw && (
                        <Button variant="ghost" size="sm" onClick={onWithdraw} className="text-[var(--text-muted)]">
                            Withdraw
                        </Button>
                    )}
                </div>

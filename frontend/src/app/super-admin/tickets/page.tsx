...
import {
    Ticket, MessageSquareWarning, CheckCircle2, Clock,
    ThumbsUp, AlertTriangle, BarChart3, Calendar,
} from 'lucide-react';
import {
                            ...
                            <Card>
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xl font-bold text-[var(--text)]">{escalatedTickets.length}</p>
                                    </div>
                                </div>
                            </Card>
                        </>
                            ...
                            <table className="w-full text-sm">
                                ...
                                <tbody className="divide-y divide-[var(--border)]">
                                    {escalatedTickets.map((ticket: SupportTicket) => {
                                        ...
                                        return (
                                            <tr key={ticket.id} className="hover:bg-[var(--bg-secondary)] transition-colors">

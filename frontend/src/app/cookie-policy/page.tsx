...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn how TalentBridge uses cookies and similar technologies to improve your experience on our job portal platform.',
};
                ...
                <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                    <div className="rounded-xl border border-[var(--border)] bg-white p-6 sm:p-10">
                        <p className="leading-relaxed text-[var(--text-secondary)]">
                            ...
                            (&quot;TalentBridge,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;)
                            uses cookies and similar tracking technologies when you visit our platform.
                            This policy should be read alongside our Privacy Policy, which provides
                            further details on how we process your personal data.
                        </p>
                        ...
                        <div className="mt-10 border-t border-[var(--border)] pt-6">
                            <p className="text-sm text-[var(--text-muted)]">
                                This Cookie Policy is effective as of February 1, 2026. TalentBridge
                                Technologies Pvt. Ltd. is registered under the laws of India with its
                                registered office in Bangalore, Karnataka. By continuing to use our

...
export const metadata: Metadata = {
  ...
  description:
    'Review the Talent Bridge terms of service. Understand the rules and guidelines for using our job portal platform.',
};
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-xl border border-[var(--border)] bg-white p-6 sm:p-10">
            <p className="leading-relaxed text-[var(--text-secondary)]">
              Welcome to TalentBridge. These Terms of Service (&quot;Terms&quot;) govern your access
              to and use of the TalentBridge website, applications, and services (collectively, the
              &quot;Platform&quot;) operated by TalentBridge Technologies Pvt. Ltd.
              (&quot;TalentBridge,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;), a
              company registered under the laws of India. Please read these terms carefully before
              using our platform.
            </p>
            ...
            <div className="mt-10 border-t border-[var(--border)] pt-6">
              <p className="text-sm text-[var(--text-muted)]">
                ...
                Technologies Pvt. Ltd. is registered under the laws of India with its registered
                office in Bangalore, Karnataka. By using our platform, you confirm that you accept
